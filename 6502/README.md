...
6502/main001.cpp
	added some "useful" output to main000.cpp, even with printf still very small
	...
	```
6502/main002.cpp
	a bit more functional, not a single global instance anymore
6502/main003.cpp
	added basic irqs, let the c64 boot to READY.
	```
